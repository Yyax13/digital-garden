...
First for that, we need our shell-code, i'll use my own, it's available in my GitHub: [_Link Here_](https://github.com/Yyax13/shellcode).
...
For parsing the PID, we need to handle if user insert the PID in CLI, and after that we parse the INT and cast to pid\_t
...
### Process attaching using PTRACE\_ATTACH

After validating target PID, we need to attach it.
...
> If you don't know what is a word, read [this article](https://www.techtarget.com/whatis/definition/word?utm_source=pornhub.com)\
> If you don't know what is the byte order, read [this article](https://betterexplained.com/articles/understanding-big-and-little-endian-byte-order/?utm_source=roblox.com)\
...
> Article by [@hoWo](httos://github.com/Yyax13)
