...
The Windows Kernel is built as a Hybrid Kernel, mixing both _microkernel_ architecture and monolithic architecture. The monolithic part manages drivers, scheduling, memory, file system, etc. It runs in the kernel space for performance.
